...
![Jupyter notebook app](../../img/Jupyter_notebook_app.png)<br>
...
4. Once the session starts, click the **Connect to Jupyter** button. A Jupyter Notebook will open in a new window.<br>
![Jupyter notebook app](../../img/Jupyter_notebook_app_launch.png)<br>
